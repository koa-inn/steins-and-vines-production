# Terms & Conditions — DRAFT (second pass, review before publishing)
...
## 13. Changes
We may update these Terms; the version in effect when you order applies to that order. The “last updated” date reflects the current version.

## 14. Contact
Steins & Vines · 11-38918 Progress Way, Squamish, BC V8B 0K7 · hello@steinsandvines.ca · 604-567-4565.

---
### Checkout acknowledgement (for the build phase)
Before placing an online reservation, the customer actively acknowledges these Terms with a required checkbox: *“I confirm I am 19 or older and agree to the Terms & Conditions, the Refund, Return & Cancellation Policy, and the Privacy Policy.”* A second, separate, **unticked** checkbox offers the newsletter: *“Email me news and offers from Steins & Vines. Unsubscribe any time.”* The build phase adds both as validated, tested controls on checkout, with the three policies linked from the first label.
